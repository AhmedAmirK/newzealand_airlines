...
module.exports = function(app) { 
    ...
    app.get('/api/booking/:email/:expiryDate/:TotalPrice/:flightNumber/:seatClass/:seatType', function(req, res) {
        ...
        var jsonObject = {
            ...
            receipt_number: "103927AGB",
            flightNumber: flightNumber,
            bookingRefNumber:"Z40X20",
            seat:{number:"50A",class:""+seatClass ,type:""+seatType}
